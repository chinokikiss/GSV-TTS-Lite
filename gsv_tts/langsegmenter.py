...
class LangSegmenter:
    def __init__(self):
        ...
        fast_langdetect.infer._default_detector = fast_langdetect.infer.LangDetector(fast_langdetect.infer.LangDetectConfig(cache_dir=os.path.join(global_config.models_dir,"fast_langdetect")))

    def getTexts(self, text, default_lang = ""):
        lang_splitter = LangSplitter(lang_map=self.DEFAULT_LANG_MAP)
