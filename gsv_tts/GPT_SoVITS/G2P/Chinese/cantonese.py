...
import cn2an
import ToJyutping
from .Normalization.char_convert import simplified_to_traditional
...
class CantoneseG2P:
    ...
    def g2p(self, text):
        ...
        phones, word2ph = self.jyuping_to_initials_finals_tones(simplified_to_traditional(text), jyuping)
        return phones, word2ph